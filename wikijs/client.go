...
// GetStrategies Get a list of all available strategies
func (c *Client) GetStrategies() (*schema.QueryStrategiesData, error) {
	return query[schema.QueryStrategiesData](c, nil)
}

// GetActiveStrategies Get a list of all active strategies
func (c *Client) GetActiveStrategies(enabledOnly bool) (*schema.QueryActiveStrategiesData, error) {
	variables := map[string]interface{}{
		"enabledOnly": gqlc.Boolean(enabledOnly),
	}
	return query[schema.QueryActiveStrategiesData](c, variables)
}

func (c *Client) UpdateActiveStrategies(strategies []schema.AuthenticationStrategyInput) (*schema.UpdateActiveStrategiesData, error) {
	variables := map[string]interface{}{
		"strategies": strategies,
	}
	return mutate[schema.UpdateActiveStrategiesData](c, variables)
}
